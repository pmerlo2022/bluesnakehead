...
| --------- | --------------- | ------------ | --------- |
| RACK3_MLAG | Vlan4094 | 172.20.1.16 | Port-Channel151 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet29/1 | P2P_LINK_TO_DC1-POD1-SPINE1_Ethernet6/1 | routed | - | 172.17.1.73/31 | default | 9214 | false | - | - |
| Ethernet30/1 | P2P_LINK_TO_DC1-POD1-SPINE2_Ethernet6/1 | routed | - | 172.17.1.75/31 | default | 9214 | false | - | - |
| Ethernet31/1 | P2P_LINK_TO_DC1-POD1-SPINE3_Ethernet6/1 | routed | - | 172.17.1.77/31 | default | 9214 | false | - | - |
| Ethernet32/1 | P2P_LINK_TO_DC1-POD1-SPINE4_Ethernet6/1 | routed | - | 172.17.1.79/31 | default | 9214 | false | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.4.1.12/32 |
...
| Vlan3099 |  Cust_A_VRF  |  172.20.1.17/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3199 |  Cust_B_opzone  |  172.20.1.17/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.20.1.17/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------------- | -------------- |
| 172.17.1.72 | 65001.100 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.1.74 | 65001.102 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.1.76 | 65001.100 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.1.78 | 65001.100 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.20.1.16 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.20.1.16 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_A_VRF | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.20.1.16 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_B_opzone | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 10.4.1.12:10100 | 10100:10100 | - | - | learned |
| 133 | 10.4.1.12:10133 | 10133:10133 | - | - | learned |
| 167 | 10.4.1.12:10167 | 10167:10167 | - | - | learned |
| 200 | 10.4.1.12:20200 | 20200:20200 | - | - | learned |
| 233 | 10.4.1.12:20233 | 20233:20233 | - | - | learned |
| 267 | 10.4.1.12:20267 | 20267:20267 | - | - | learned |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Cust_A_VRF | 10.4.1.12:100 | connected |
| Cust_B_opzone | 10.4.1.12:200 | connected |
...
router bgp 65111.300
   ...
   neighbor 172.17.1.72 remote-as 65001.100
   neighbor 172.17.1.72 description DC1-POD1-SPINE1_Ethernet6/1
   neighbor 172.17.1.74 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.1.74 remote-as 65001.102
   neighbor 172.17.1.74 description DC1-POD1-SPINE2_Ethernet6/1
   neighbor 172.17.1.76 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.1.76 remote-as 65001.100
   neighbor 172.17.1.76 description DC1-POD1-SPINE3_Ethernet6/1
   neighbor 172.17.1.78 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.1.78 remote-as 65001.100
   neighbor 172.17.1.78 description DC1-POD1-SPINE4_Ethernet6/1
   neighbor 172.20.1.16 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.20.1.16 description DC1-POD1-LEAF3A
