...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | mgmt | 10.6.35.40/24 | 10.6.65.1 |
...
| --------- | --------------- | ------------ | --------- |
| RACK11_MLAG | Vlan4094 | 172.19.65.81 | Port-Channel151 |
...
mlag configuration
   ...
   peer-address 172.19.65.81
   peer-address heartbeat 10.6.35.40 vrf mgmt
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet29/1 | P2P_LINK_TO_DC2-POD1-SPINE1_Ethernet21/1 | routed | - | 172.17.65.65/31 | default | 9214 | false | - | - |
| Ethernet30/1 | P2P_LINK_TO_DC2-POD1-SPINE2_Ethernet21/1 | routed | - | 172.17.65.67/31 | default | 9214 | false | - | - |
| Ethernet31/1 | P2P_LINK_TO_DC2-POD1-SPINE3_Ethernet21/1 | routed | - | 172.17.65.69/31 | default | 9214 | false | - | - |
| Ethernet32/1 | P2P_LINK_TO_DC2-POD1-SPINE4_Ethernet21/1 | routed | - | 172.17.65.71/31 | default | 9214 | false | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.4.65.43/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.5.65.43/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 10.4.65.43/32
!
interface Loopback1
   description VTEP_VXLAN_Tunnel_Source
   no shutdown
   ip address 10.5.65.43/32
```
...
| Vlan3099 |  Cust_A_VRF  |  172.19.65.80/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3199 |  Cust_B_VRF  |  172.19.65.80/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.19.65.80/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- |
| 172.17.65.64 | 64801 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.17.65.66 | 64802 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.17.65.68 | 64803 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.17.65.70 | 64804 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.19.65.81 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
| 172.19.65.81 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_A_VRF | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
| 172.19.65.81 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_B_VRF | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 10.4.65.43:10100 | 10100:10100 | - | - | learned |
| 133 | 10.4.65.43:10133 | 10133:10133 | - | - | learned |
| 167 | 10.4.65.43:10167 | 10167:10167 | - | - | learned |
| 200 | 10.4.65.43:20200 | 20200:20200 | - | - | learned |
| 233 | 10.4.65.43:20233 | 20233:20233 | - | - | learned |
| 267 | 10.4.65.43:20267 | 20267:20267 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Cust_A_VRF | 10.4.65.43:100 | connected |
| Cust_B_VRF | 10.4.65.43:200 | connected |
...
router bgp 65111
   ...
   neighbor 172.17.65.64 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.65.64 remote-as 64801
   neighbor 172.17.65.64 description DC2-POD1-SPINE1_Ethernet21/1
   neighbor 172.17.65.66 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.65.66 remote-as 64802
   neighbor 172.17.65.66 description DC2-POD1-SPINE2_Ethernet21/1
   neighbor 172.17.65.68 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.65.68 remote-as 64803
   neighbor 172.17.65.68 description DC2-POD1-SPINE3_Ethernet21/1
   neighbor 172.17.65.70 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.65.70 remote-as 64804
   neighbor 172.17.65.70 description DC2-POD1-SPINE4_Ethernet21/1
   neighbor 172.19.65.81 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.19.65.81 description DC2-POD1-LEAF11B
