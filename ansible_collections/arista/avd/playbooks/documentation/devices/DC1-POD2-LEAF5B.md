...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | mgmt | 10.6.34.10/24 | 10.6.1.1 |
...
| ------- | -------- | ---------- | ----- |
| - | AMS DC1 DC1_POD2 DC1-POD2-LEAF5B | All | Disabled |

### SNMP Device Configuration

```eos
!
snmp-server location AMS DC1 DC1_POD2 DC1-POD2-LEAF5B
```
...
| --------- | --------------- | ------------ | --------- |
| RACK5_MLAG | Vlan4094 | 172.20.2.16 | Port-Channel151 |
...
mlag configuration
   ...
   peer-address 172.20.2.16
   peer-address heartbeat 10.6.34.10 vrf mgmt
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet15/1 | MLAG_PEER_DC1-POD2-LEAF5A_Ethernet15/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 151 |
| Ethernet16/1 | MLAG_PEER_DC1-POD2-LEAF5A_Ethernet16/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 151 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet29/1 | P2P_LINK_TO_DC1-POD2-SPINE1_Ethernet10/1 | routed | - | 172.17.2.73/31 | default | 9214 | false | - | - |
| Ethernet30/1 | P2P_LINK_TO_DC1-POD2-SPINE2_Ethernet10/1 | routed | - | 172.17.2.75/31 | default | 9214 | false | - | - |
| Ethernet31/1 | P2P_LINK_TO_DC1-POD2-SPINE3_Ethernet10/1 | routed | - | 172.17.2.77/31 | default | 9214 | false | - | - |
| Ethernet32/1 | P2P_LINK_TO_DC1-POD2-SPINE4_Ethernet10/1 | routed | - | 172.17.2.79/31 | default | 9214 | false | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel151 | MLAG_PEER_DC1-POD2-LEAF5A_Po151 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.4.2.12/32 |
...
| Vlan3099 |  Cust_A_VRF  |  172.20.2.17/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3199 |  Cust_B_opzone  |  172.20.2.17/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.20.2.17/31  |  -  |  -  |  -  |  -  |  -  |
...
| 172.17.2.72 | 65001.200 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.2.74 | 65001.200 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.2.76 | 65001.200 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.2.78 | 65001.200 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.20.2.16 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.20.2.16 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_A_VRF | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.20.2.16 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_B_opzone | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 67 | 10.4.2.12:20067 | 20067:20067 | - | - | learned |
| 100 | 10.4.2.12:10100 | 10100:10100 | - | - | learned |
| 111 | 10.4.2.12:10111 | 10111:10111 | - | - | learned |
| 112 | 10.4.2.12:10112 | 10112:10112 | - | - | learned |
| 211 | 10.4.2.12:20211 | 20211:20211 | - | - | learned |
| 212 | 10.4.2.12:20212 | 20212:20212 | - | - | learned |
| 1500 | 10.4.2.12:11500 | 11500:11500 | - | - | learned |
| 1600 | 10.4.2.12:11600 | 11600:11600 | - | - | learned |
| 2520 | 10.4.2.12:22520 | 22520:22520 | - | - | learned |
| 2620 | 10.4.2.12:22620 | 22620:22620 | - | - | learned |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Cust_A_VRF | 10.4.2.12:100 | connected |
| Cust_B_opzone | 10.4.2.12:200 | connected |
...
router bgp 65112.500
   ...
   neighbor 172.17.2.72 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.2.72 remote-as 65001.200
   neighbor 172.17.2.72 description DC1-POD2-SPINE1_Ethernet10/1
   neighbor 172.17.2.74 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.2.74 remote-as 65001.200
   neighbor 172.17.2.74 description DC1-POD2-SPINE2_Ethernet10/1
   neighbor 172.17.2.76 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.2.76 remote-as 65001.200
   neighbor 172.17.2.76 description DC1-POD2-SPINE3_Ethernet10/1
   neighbor 172.17.2.78 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.2.78 remote-as 65001.200
   neighbor 172.17.2.78 description DC1-POD2-SPINE4_Ethernet10/1
   neighbor 172.20.2.16 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.20.2.16 description DC1-POD2-LEAF5A
