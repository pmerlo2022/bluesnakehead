...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | mgmt | 10.6.2.8/24 | 10.6.1.1 |
...
| --------- | --------------- | ------------ | --------- |
| RACK4_MLAG | Vlan4094 | 172.20.1.20 | Port-Channel151 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet29/1 | P2P_LINK_TO_DC1-POD1-SPINE1_Ethernet8/1 | routed | - | 172.17.1.89/31 | default | 9214 | false | - | - |
| Ethernet30/1 | P2P_LINK_TO_DC1-POD1-SPINE2_Ethernet8/1 | routed | - | 172.17.1.91/31 | default | 9214 | false | - | - |
| Ethernet31/1 | P2P_LINK_TO_DC1-POD1-SPINE3_Ethernet8/1 | routed | - | 172.17.1.93/31 | default | 9214 | false | - | - |
| Ethernet32/1 | P2P_LINK_TO_DC1-POD1-SPINE4_Ethernet8/1 | routed | - | 172.17.1.95/31 | default | 9214 | false | - | - |
...
interface Ethernet32/1
   description P2P_LINK_TO_DC1-POD1-SPINE4_Ethernet8/1
   no shutdown
   mtu 9214
   no switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.4.1.14/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.5.1.13/32 |
...
| Vlan3124 |  Cust_A_VRF  |  172.20.1.21/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3224 |  Cust_B_VRF  |  172.20.1.21/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------------- | -------------- |
| 172.17.1.88 | 65001.100 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.1.90 | 65001.102 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.1.92 | 65001.100 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.1.94 | 65001.100 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.20.1.20 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.20.1.20 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_A_VRF | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.20.1.20 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_B_VRF | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 67 | 10.4.1.14:20067 | 20067:20067 | - | - | learned |
| 100 | 10.4.1.14:10100 | 10100:10100 | - | - | learned |
| 112 | 10.4.1.14:10112 | 10112:10112 | - | - | learned |
| 211 | 10.4.1.14:20211 | 20211:20211 | - | - | learned |
| 212 | 10.4.1.14:20212 | 20212:20212 | - | - | learned |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Cust_A_VRF | 10.4.1.14:125 | connected |
| Cust_B_VRF | 10.4.1.14:225 | connected |
...
router bgp 65111.400
   ...
   neighbor 172.17.1.88 remote-as 65001.100
   neighbor 172.17.1.88 description DC1-POD1-SPINE1_Ethernet8/1
   neighbor 172.17.1.90 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.1.90 remote-as 65001.102
   neighbor 172.17.1.90 description DC1-POD1-SPINE2_Ethernet8/1
   neighbor 172.17.1.92 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.1.92 remote-as 65001.100
   neighbor 172.17.1.92 description DC1-POD1-SPINE3_Ethernet8/1
   neighbor 172.17.1.94 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.1.94 remote-as 65001.100
   neighbor 172.17.1.94 description DC1-POD1-SPINE4_Ethernet8/1
   neighbor 172.20.1.20 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.20.1.20 description DC1-POD1-LEAF4A
