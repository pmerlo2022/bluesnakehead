...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet29/1 | P2P_LINK_TO_DC1-POD1-SPINE1_Ethernet8/1 | routed | - | 172.17.0.209/31 | default | 9214 | false | - | - |
| Ethernet30/1 | P2P_LINK_TO_DC1-POD1-SPINE2_Ethernet8/1 | routed | - | 172.17.0.211/31 | default | 9214 | false | - | - |
| Ethernet31/1 | P2P_LINK_TO_DC1-POD1-SPINE3_Ethernet8/1 | routed | - | 172.17.0.213/31 | default | 9214 | false | - | - |
| Ethernet32/1 | P2P_LINK_TO_DC1-POD1-SPINE4_Ethernet8/1 | routed | - | 172.17.0.215/31 | default | 9214 | false | - | - |
...
| -------- | --------- | --- | -------------- | -------------- |
| 172.17.0.208 | 64601 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.0.210 | 64602 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.0.212 | 64603 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.0.214 | 64604 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
...
router bgp 64904
   ...
   neighbor 172.17.0.208 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.0.208 remote-as 64601
   neighbor 172.17.0.208 description DC1-POD1-SPINE1_Ethernet8/1
   neighbor 172.17.0.210 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.0.210 remote-as 64602
   neighbor 172.17.0.210 description DC1-POD1-SPINE2_Ethernet8/1
   neighbor 172.17.0.212 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.0.212 remote-as 64603
   neighbor 172.17.0.212 description DC1-POD1-SPINE3_Ethernet8/1
   neighbor 172.17.0.214 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.0.214 remote-as 64604
   neighbor 172.17.0.214 description DC1-POD1-SPINE4_Ethernet8/1
