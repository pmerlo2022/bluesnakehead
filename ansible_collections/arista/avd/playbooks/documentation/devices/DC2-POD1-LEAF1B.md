...
| --------- | --------------- | ------------ | --------- |
| RACK1_MLAG | Vlan4094 | 172.20.32.0 | Port-Channel5 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | P2P_LINK_TO_DC2-POD1-LEAF1A_Ethernet5 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 5 |
| Ethernet6 | MLAG_PEER_DC2-POD1-LEAF1A_Ethernet6 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1/1 | P2P_LINK_TO_DC1-POD1-SPINE1_Ethernet4 | routed | - | 172.17.32.9/31 | default | 9214 | false | - | - |
| Ethernet1/2 | P2P_LINK_TO_DC1-POD1-SPINE2_Ethernet5 | routed | - | 172.17.32.11/31 | default | 9214 | false | - | - |
| Ethernet1/3 | P2P_LINK_TO_DC1-POD1-SPINE3_Ethernet6 | routed | - | 172.17.32.13/31 | default | 9214 | false | - | - |
| Ethernet1/4 | P2P_LINK_TO_DC1-POD1-SPINE4_Ethernet7 | routed | - | 172.17.32.15/31 | default | 9214 | false | - | - |
...
!
interface Ethernet5
   description P2P_LINK_TO_DC2-POD1-LEAF1A_Ethernet5
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description MLAG_PEER_DC2-POD1-LEAF1A_Ethernet6
   no shutdown
   channel-group 5 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel5 | MLAG_PEER_DC2-POD1-LEAF1A_Po5 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel5
   description MLAG_PEER_DC2-POD1-LEAF1A_Po5
   no shutdown
   switchport
...
| 10.4.32.5 | 65211.1400 | default | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS |
| 10.4.32.6 | 65211.1400 | default | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS |
| 11.1.1.18 | 65101 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.32.8 | 65001.100 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.32.10 | 65001.100 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.32.12 | 65001.100 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.32.14 | 65001.100 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
...
| --- | ------------------- | ------------ |
| Common_VRF | 10.4.32.4:1025 | connected |
...
router bgp 65211.100
   ...
   neighbor 10.4.32.5 remote-as 65211.1400
   neighbor 10.4.32.5 description DC2-POD1-LEAF14A
   neighbor 10.4.32.6 peer group EVPN-OVERLAY-PEERS
   neighbor 10.4.32.6 remote-as 65211.1400
   neighbor 10.4.32.6 description DC2-POD1-LEAF14B
   ...
   neighbor 172.17.32.8 remote-as 65001.100
   neighbor 172.17.32.8 description DC1-POD1-SPINE1_Ethernet4
   neighbor 172.17.32.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.32.10 remote-as 65001.100
   neighbor 172.17.32.10 description DC1-POD1-SPINE2_Ethernet5
   neighbor 172.17.32.12 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.32.12 remote-as 65001.100
   neighbor 172.17.32.12 description DC1-POD1-SPINE3_Ethernet6
   neighbor 172.17.32.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.32.14 remote-as 65001.100
   neighbor 172.17.32.14 description DC1-POD1-SPINE4_Ethernet7
