...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | mgmt | 10.6.35.21/24 | 10.6.65.1 |
...
| --------- | --------------- | ------------ | --------- |
| RACK1_MLAG | Vlan4094 | 172.19.65.38 | Port-Channel151 |
...
mlag configuration
   ...
   peer-address 172.19.65.38
   peer-address heartbeat 10.6.35.21 vrf mgmt
...
| Ethernet32/1 | P2P_LINK_TO_DC2-POD1-SPINE4_Ethernet2/1 | routed | - | 172.17.64.167/31 | default | 9214 | false | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.4.65.23/32 |
...
| Vlan3099 |  Cust_A_VRF  |  172.19.65.39/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3199 |  Cust_B_VRF  |  172.19.65.39/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.19.65.39/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------------- | -------------- |
| 172.17.64.160 | 64801 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.64.162 | 64802 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 200 | 10.4.65.23:20200 | 20200:20200 | - | - | learned |
| 233 | 10.4.65.23:20233 | 20233:20233 | - | - | learned |
| 267 | 10.4.65.23:20267 | 20267:20267 | - | - | learned |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Cust_A_VRF | 10.4.65.23:100 | connected |
| Cust_B_VRF | 10.4.65.23:200 | connected |
...
router bgp 65101
   ...
   neighbor 172.17.64.160 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.64.160 remote-as 64801
   neighbor 172.17.64.160 description DC2-POD1-SPINE1_Ethernet2/1
   neighbor 172.17.64.162 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.64.162 remote-as 64802
   neighbor 172.17.64.162 description DC2-POD1-SPINE2_Ethernet2/1
   neighbor 172.17.64.164 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.64.164 remote-as 64803
   neighbor 172.17.64.164 description DC2-POD1-SPINE3_Ethernet2/1
   neighbor 172.17.64.166 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.64.166 remote-as 64804
