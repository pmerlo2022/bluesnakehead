...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | mgmt | 10.6.35.41/24 | 10.6.65.1 |
...
| --------- | --------------- | ------------ | --------- |
| RACK11_MLAG | Vlan4094 | 172.19.65.80 | Port-Channel151 |
...
mlag configuration
   ...
   peer-address 172.19.65.80
   peer-address heartbeat 10.6.35.41 vrf mgmt
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet29/1 | P2P_LINK_TO_DC2-POD1-SPINE1_Ethernet22/1 | routed | - | 172.17.65.73/31 | default | 9214 | false | - | - |
| Ethernet30/1 | P2P_LINK_TO_DC2-POD1-SPINE2_Ethernet22/1 | routed | - | 172.17.65.75/31 | default | 9214 | false | - | - |
| Ethernet31/1 | P2P_LINK_TO_DC2-POD1-SPINE3_Ethernet22/1 | routed | - | 172.17.65.77/31 | default | 9214 | false | - | - |
| Ethernet32/1 | P2P_LINK_TO_DC2-POD1-SPINE4_Ethernet22/1 | routed | - | 172.17.65.79/31 | default | 9214 | false | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.4.65.44/32 |
...
| Vlan3099 |  Cust_A_VRF  |  172.19.65.81/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3199 |  Cust_B_VRF  |  172.19.65.81/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.19.65.81/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------------- | -------------- |
| 172.17.65.72 | 64801 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.65.74 | 64802 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.65.76 | 64803 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.65.78 | 64804 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.19.65.80 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.19.65.80 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_A_VRF | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.19.65.80 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_B_VRF | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 10.4.65.44:10100 | 10100:10100 | - | - | learned |
| 133 | 10.4.65.44:10133 | 10133:10133 | - | - | learned |
| 167 | 10.4.65.44:10167 | 10167:10167 | - | - | learned |
| 200 | 10.4.65.44:20200 | 20200:20200 | - | - | learned |
| 233 | 10.4.65.44:20233 | 20233:20233 | - | - | learned |
| 267 | 10.4.65.44:20267 | 20267:20267 | - | - | learned |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Cust_A_VRF | 10.4.65.44:100 | connected |
| Cust_B_VRF | 10.4.65.44:200 | connected |
...
router bgp 65111
   ...
   neighbor 172.17.65.72 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.65.72 remote-as 64801
   neighbor 172.17.65.72 description DC2-POD1-SPINE1_Ethernet22/1
   neighbor 172.17.65.74 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.65.74 remote-as 64802
   neighbor 172.17.65.74 description DC2-POD1-SPINE2_Ethernet22/1
   neighbor 172.17.65.76 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.65.76 remote-as 64803
   neighbor 172.17.65.76 description DC2-POD1-SPINE3_Ethernet22/1
   neighbor 172.17.65.78 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.65.78 remote-as 64804
   neighbor 172.17.65.78 description DC2-POD1-SPINE4_Ethernet22/1
   neighbor 172.19.65.80 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.19.65.80 description DC2-POD1-LEAF11A
