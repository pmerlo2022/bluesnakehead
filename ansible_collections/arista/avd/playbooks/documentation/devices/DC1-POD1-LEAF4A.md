...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet29/1 | P2P_LINK_TO_DC1-POD1-SPINE1_Ethernet7/1 | routed | - | 172.17.0.201/31 | default | 9214 | false | - | - |
| Ethernet30/1 | P2P_LINK_TO_DC1-POD1-SPINE2_Ethernet7/1 | routed | - | 172.17.0.203/31 | default | 9214 | false | - | - |
| Ethernet31/1 | P2P_LINK_TO_DC1-POD1-SPINE3_Ethernet7/1 | routed | - | 172.17.0.205/31 | default | 9214 | false | - | - |
| Ethernet32/1 | P2P_LINK_TO_DC1-POD1-SPINE4_Ethernet7/1 | routed | - | 172.17.0.207/31 | default | 9214 | false | - | - |
...
| -------- | --------- | --- | -------------- | -------------- |
| 172.17.0.200 | 64601 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.0.202 | 64602 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.0.204 | 64603 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.0.206 | 64604 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
...
router bgp 64904
   ...
   neighbor 172.17.0.200 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.0.200 remote-as 64601
   neighbor 172.17.0.200 description DC1-POD1-SPINE1_Ethernet7/1
   neighbor 172.17.0.202 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.0.202 remote-as 64602
   neighbor 172.17.0.202 description DC1-POD1-SPINE2_Ethernet7/1
   neighbor 172.17.0.204 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.0.204 remote-as 64603
   neighbor 172.17.0.204 description DC1-POD1-SPINE3_Ethernet7/1
   neighbor 172.17.0.206 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.0.206 remote-as 64604
   neighbor 172.17.0.206 description DC1-POD1-SPINE4_Ethernet7/1
