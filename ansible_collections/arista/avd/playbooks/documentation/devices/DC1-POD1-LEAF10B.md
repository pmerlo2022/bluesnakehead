...
| --------- | --------------- | ------------ | --------- |
| RACK10_MLAG | Vlan4094 | 172.20.1.4 | Port-Channel5 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | MLAG_PEER_DC1-POD1-LEAF10A_Ethernet5 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 5 |
| Ethernet6 | MLAG_PEER_DC1-POD1-LEAF10A_Ethernet6 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 5 |
...
!
interface Ethernet5
   description MLAG_PEER_DC1-POD1-LEAF10A_Ethernet5
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description MLAG_PEER_DC1-POD1-LEAF10A_Ethernet6
   no shutdown
   channel-group 5 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel5 | MLAG_PEER_DC1-POD1-LEAF10A_Po5 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel5
   description MLAG_PEER_DC1-POD1-LEAF10A_Po5
   no shutdown
   switchport
