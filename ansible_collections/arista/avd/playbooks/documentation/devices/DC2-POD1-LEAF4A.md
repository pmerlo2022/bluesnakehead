...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | mgmt | 10.6.32.7/24 | 10.6.1.1 |
...
| ------- | -------- | ---------- | ----- |
| - | AMS DC2 DC2_POD1 DC2-POD1-LEAF4A | All | Disabled |

### SNMP Device Configuration

```eos
!
snmp-server location AMS DC2 DC2_POD1 DC2-POD1-LEAF4A
```
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet29/1 | P2P_LINK_TO_DC2-POD1-SPINE1_Ethernet7/1 | routed | - | 172.17.32.49/31 | default | 9214 | false | - | - |
| Ethernet30/1 | P2P_LINK_TO_DC2-POD1-SPINE2_Ethernet7/1 | routed | - | 172.17.32.51/31 | default | 9214 | false | - | - |
| Ethernet31/1 | P2P_LINK_TO_DC2-POD1-SPINE3_Ethernet7/1 | routed | - | 172.17.32.53/31 | default | 9214 | false | - | - |
| Ethernet32/1 | P2P_LINK_TO_DC2-POD1-SPINE4_Ethernet7/1 | routed | - | 172.17.32.55/31 | default | 9214 | false | - | - |
...
interface Ethernet29/1
   ...
   mtu 9214
   no switchport
   ip address 172.17.32.49/31
   ptp enable
   service-profile P2P-QOS-PROFILE
!
interface Ethernet30/1
   description P2P_LINK_TO_DC2-POD1-SPINE2_Ethernet7/1
   no shutdown
   mtu 9214
   no switchport
   ip address 172.17.32.51/31
   ptp enable
   service-profile P2P-QOS-PROFILE
!
interface Ethernet31/1
   description P2P_LINK_TO_DC2-POD1-SPINE3_Ethernet7/1
   no shutdown
   mtu 9214
   no switchport
   ip address 172.17.32.53/31
   ptp enable
   service-profile P2P-QOS-PROFILE
!
interface Ethernet32/1
   description P2P_LINK_TO_DC2-POD1-SPINE4_Ethernet7/1
   no shutdown
   mtu 9214
   no switchport
   ip address 172.17.32.55/31
   ptp enable
   service-profile P2P-QOS-PROFILE
```
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.4.32.9/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.5.32.9/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 10.4.32.9/32
!
interface Loopback1
   description VTEP_VXLAN_Tunnel_Source
   no shutdown
   ip address 10.5.32.9/32
```
...
| Vlan3099 |  Cust_A_VRF  |  172.20.32.12/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3199 |  Cust_B_opzone  |  172.20.32.12/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.20.32.12/31  |  -  |  -  |  -  |  -  |  -  |
...
!
interface Vxlan1
   description DC2-POD1-LEAF4A_VTEP
...
| -------- | --------- | --- | -------------- | -------------- |
| 172.17.32.48 | 65002.100 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.32.50 | 65002.100 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.32.52 | 65002.100 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.32.54 | 65002.100 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.20.32.13 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.20.32.13 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_A_VRF | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.20.32.13 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_B_opzone | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 67 | 10.4.32.9:20067 | 20067:20067 | - | - | learned |
| 100 | 10.4.32.9:10100 | 10100:10100 | - | - | learned |
| 111 | 10.4.32.9:10111 | 10111:10111 | - | - | learned |
| 112 | 10.4.32.9:10112 | 10112:10112 | - | - | learned |
| 211 | 10.4.32.9:20211 | 20211:20211 | - | - | learned |
| 212 | 10.4.32.9:20212 | 20212:20212 | - | - | learned |
| 1500 | 10.4.32.9:11500 | 11500:11500 | - | - | learned |
| 1600 | 10.4.32.9:11600 | 11600:11600 | - | - | learned |
| 2520 | 10.4.32.9:22520 | 22520:22520 | - | - | learned |
| 2620 | 10.4.32.9:22620 | 22620:22620 | - | - | learned |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Cust_A_VRF | 10.4.32.9:100 | connected |
| Cust_B_opzone | 10.4.32.9:200 | connected |
...
router bgp 65112.400
   ...
   neighbor 172.17.32.48 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.32.48 remote-as 65002.100
   neighbor 172.17.32.48 description DC2-POD1-SPINE1_Ethernet7/1
   neighbor 172.17.32.50 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.32.50 remote-as 65002.100
   neighbor 172.17.32.50 description DC2-POD1-SPINE2_Ethernet7/1
   neighbor 172.17.32.52 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.32.52 remote-as 65002.100
   neighbor 172.17.32.52 description DC2-POD1-SPINE3_Ethernet7/1
   neighbor 172.17.32.54 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.32.54 remote-as 65002.100
   neighbor 172.17.32.54 description DC2-POD1-SPINE4_Ethernet7/1
   neighbor 172.20.32.13 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.20.32.13 description DC2-POD1-LEAF4B
