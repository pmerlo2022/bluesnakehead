...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | mgmt | 10.6.35.26/24 | 10.6.65.1 |
...
| --------- | --------------- | ------------ | --------- |
| RACK4_MLAG | Vlan4094 | 172.19.65.53 | Port-Channel151 |
...
mlag configuration
   ...
   peer-address 172.19.65.53
   peer-address heartbeat 10.6.35.26 vrf mgmt
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet29/1 | P2P_LINK_TO_DC2-POD1-SPINE1_Ethernet7/1 | routed | - | 172.17.64.209/31 | default | 9214 | false | - | - |
| Ethernet30/1 | P2P_LINK_TO_DC2-POD1-SPINE2_Ethernet7/1 | routed | - | 172.17.64.211/31 | default | 9214 | false | - | - |
| Ethernet31/1 | P2P_LINK_TO_DC2-POD1-SPINE3_Ethernet7/1 | routed | - | 172.17.64.213/31 | default | 9214 | false | - | - |
| Ethernet32/1 | P2P_LINK_TO_DC2-POD1-SPINE4_Ethernet7/1 | routed | - | 172.17.64.215/31 | default | 9214 | false | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.4.65.29/32 |
...
| Vlan3099 |  Cust_A_VRF  |  172.19.65.52/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3199 |  Cust_B_VRF  |  172.19.65.52/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.19.65.52/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------------- | -------------- |
| 172.17.64.208 | 64801 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.64.210 | 64802 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.64.212 | 64803 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.64.214 | 64804 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.19.65.53 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.19.65.53 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_A_VRF | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.19.65.53 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_B_VRF | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 10.4.65.29:10100 | 10100:10100 | - | - | learned |
| 133 | 10.4.65.29:10133 | 10133:10133 | - | - | learned |
| 167 | 10.4.65.29:10167 | 10167:10167 | - | - | learned |
| 200 | 10.4.65.29:20200 | 20200:20200 | - | - | learned |
| 233 | 10.4.65.29:20233 | 20233:20233 | - | - | learned |
| 267 | 10.4.65.29:20267 | 20267:20267 | - | - | learned |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Cust_A_VRF | 10.4.65.29:100 | connected |
| Cust_B_VRF | 10.4.65.29:200 | connected |
...
router bgp 65104
   ...
   neighbor 172.17.64.208 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.64.208 remote-as 64801
   neighbor 172.17.64.208 description DC2-POD1-SPINE1_Ethernet7/1
   neighbor 172.17.64.210 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.64.210 remote-as 64802
   neighbor 172.17.64.210 description DC2-POD1-SPINE2_Ethernet7/1
   neighbor 172.17.64.212 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.64.212 remote-as 64803
   neighbor 172.17.64.212 description DC2-POD1-SPINE3_Ethernet7/1
   neighbor 172.17.64.214 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.64.214 remote-as 64804
   neighbor 172.17.64.214 description DC2-POD1-SPINE4_Ethernet7/1
   neighbor 172.19.65.53 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.19.65.53 description DC2-POD1-LEAF4B
