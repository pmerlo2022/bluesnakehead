...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | mgmt | 10.6.34.16/24 | 10.6.1.1 |
...
| ------- | -------- | ---------- | ----- |
| - | AMS DC1 DC1_POD2 DC1-POD2-LEAF8B | All | Disabled |

### SNMP Device Configuration

```eos
!
snmp-server location AMS DC1 DC1_POD2 DC1-POD2-LEAF8B
```
...
| --------- | --------------- | ------------ | --------- |
| RACK8_MLAG | Vlan4094 | 172.20.2.28 | Port-Channel151 |
...
mlag configuration
   ...
   peer-address 172.20.2.28
   peer-address heartbeat 10.6.34.16 vrf mgmt
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet15/1 | MLAG_PEER_DC1-POD2-LEAF8A_Ethernet15/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 151 |
| Ethernet16/1 | MLAG_PEER_DC1-POD2-LEAF8A_Ethernet16/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 151 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet29/1 | P2P_LINK_TO_DC1-POD2-SPINE1_Ethernet16/1 | routed | - | 172.17.2.121/31 | default | 9214 | false | - | - |
| Ethernet30/1 | P2P_LINK_TO_DC1-POD2-SPINE2_Ethernet16/1 | routed | - | 172.17.2.123/31 | default | 9214 | false | - | - |
| Ethernet31/1 | P2P_LINK_TO_DC1-POD2-SPINE3_Ethernet16/1 | routed | - | 172.17.2.125/31 | default | 9214 | false | - | - |
| Ethernet32/1 | P2P_LINK_TO_DC1-POD2-SPINE4_Ethernet16/1 | routed | - | 172.17.2.127/31 | default | 9214 | false | - | - |
...
interface Ethernet15/1
   description MLAG_PEER_DC1-POD2-LEAF8A_Ethernet15/1
   no shutdown
   channel-group 151 mode active
!
interface Ethernet16/1
   description MLAG_PEER_DC1-POD2-LEAF8A_Ethernet16/1
   no shutdown
   channel-group 151 mode active
!
interface Ethernet29/1
   description P2P_LINK_TO_DC1-POD2-SPINE1_Ethernet16/1
   no shutdown
   mtu 9214
   no switchport
   ip address 172.17.2.121/31
   ptp enable
   service-profile P2P-QOS-PROFILE
!
interface Ethernet30/1
   description P2P_LINK_TO_DC1-POD2-SPINE2_Ethernet16/1
   no shutdown
   mtu 9214
   no switchport
   ip address 172.17.2.123/31
   ptp enable
   service-profile P2P-QOS-PROFILE
!
interface Ethernet31/1
   description P2P_LINK_TO_DC1-POD2-SPINE3_Ethernet16/1
   no shutdown
   mtu 9214
   no switchport
   ip address 172.17.2.125/31
   ptp enable
   service-profile P2P-QOS-PROFILE
!
interface Ethernet32/1
   description P2P_LINK_TO_DC1-POD2-SPINE4_Ethernet16/1
   no shutdown
   mtu 9214
   no switchport
   ip address 172.17.2.127/31
   ptp enable
   service-profile P2P-QOS-PROFILE
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel151 | MLAG_PEER_DC1-POD2-LEAF8A_Po151 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel151
   description MLAG_PEER_DC1-POD2-LEAF8A_Po151
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.4.2.18/32 |
...
| Vlan3099 |  Cust_A_VRF  |  172.20.2.29/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3199 |  Cust_B_opzone  |  172.20.2.29/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.20.2.29/31  |  -  |  -  |  -  |  -  |  -  |
...
!
interface Vxlan1
   description DC1-POD2-LEAF8B_VTEP
...
| 172.17.2.120 | 65001.200 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.2.122 | 65001.200 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.2.124 | 65001.200 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.2.126 | 65001.200 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.20.2.28 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.20.2.28 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_A_VRF | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.20.2.28 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_B_opzone | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 67 | 10.4.2.18:20067 | 20067:20067 | - | - | learned |
| 100 | 10.4.2.18:10100 | 10100:10100 | - | - | learned |
| 111 | 10.4.2.18:10111 | 10111:10111 | - | - | learned |
| 112 | 10.4.2.18:10112 | 10112:10112 | - | - | learned |
| 211 | 10.4.2.18:20211 | 20211:20211 | - | - | learned |
| 212 | 10.4.2.18:20212 | 20212:20212 | - | - | learned |
| 1500 | 10.4.2.18:11500 | 11500:11500 | - | - | learned |
| 1600 | 10.4.2.18:11600 | 11600:11600 | - | - | learned |
| 2520 | 10.4.2.18:22520 | 22520:22520 | - | - | learned |
| 2620 | 10.4.2.18:22620 | 22620:22620 | - | - | learned |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Cust_A_VRF | 10.4.2.18:100 | connected |
| Cust_B_opzone | 10.4.2.18:200 | connected |
...
router bgp 65112.800
   ...
   neighbor 172.17.2.120 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.2.120 remote-as 65001.200
   neighbor 172.17.2.120 description DC1-POD2-SPINE1_Ethernet16/1
   neighbor 172.17.2.122 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.2.122 remote-as 65001.200
   neighbor 172.17.2.122 description DC1-POD2-SPINE2_Ethernet16/1
   neighbor 172.17.2.124 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.2.124 remote-as 65001.200
   neighbor 172.17.2.124 description DC1-POD2-SPINE3_Ethernet16/1
   neighbor 172.17.2.126 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.2.126 remote-as 65001.200
   neighbor 172.17.2.126 description DC1-POD2-SPINE4_Ethernet16/1
   neighbor 172.20.2.28 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.20.2.28 description DC1-POD2-LEAF8A
