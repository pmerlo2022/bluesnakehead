...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet29/1 | P2P_LINK_TO_DC1-POD1-SPINE1_Ethernet17/1 | routed | - | 172.17.1.25/31 | default | 9214 | false | - | - |
| Ethernet30/1 | P2P_LINK_TO_DC1-POD1-SPINE2_Ethernet17/1 | routed | - | 172.17.1.27/31 | default | 9214 | false | - | - |
| Ethernet31/1 | P2P_LINK_TO_DC1-POD1-SPINE3_Ethernet17/1 | routed | - | 172.17.1.29/31 | default | 9214 | false | - | - |
| Ethernet32/1 | P2P_LINK_TO_DC1-POD1-SPINE4_Ethernet17/1 | routed | - | 172.17.1.31/31 | default | 9214 | false | - | - |
...
| -------- | --------- | --- | -------------- | -------------- |
| 172.17.1.24 | 64601 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.1.26 | 64602 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.1.28 | 64603 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.1.30 | 64604 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
...
router bgp 64909
   ...
   neighbor 172.17.1.24 remote-as 64601
   neighbor 172.17.1.24 description DC1-POD1-SPINE1_Ethernet17/1
   neighbor 172.17.1.26 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.1.26 remote-as 64602
   neighbor 172.17.1.26 description DC1-POD1-SPINE2_Ethernet17/1
   neighbor 172.17.1.28 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.1.28 remote-as 64603
   neighbor 172.17.1.28 description DC1-POD1-SPINE3_Ethernet17/1
   neighbor 172.17.1.30 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.1.30 remote-as 64604
   neighbor 172.17.1.30 description DC1-POD1-SPINE4_Ethernet17/1
