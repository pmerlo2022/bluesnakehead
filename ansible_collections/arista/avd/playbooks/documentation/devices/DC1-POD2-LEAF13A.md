...
| --------- | --------------- | ------------ | --------- |
| RACK13_MLAG | Vlan4094 | 172.20.2.5 | Port-Channel5 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | MLAG_PEER_DC1-POD2-LEAF13B_Ethernet5 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 5 |
| Ethernet6 | MLAG_PEER_DC1-POD2-LEAF13B_Ethernet6 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1/1 | P2P_LINK_TO_DC1-POD2-SPINE1_Ethernet4 | routed | - | 172.17.2.17/31 | default | 9214 | false | - | - |
| Ethernet1/2 | P2P_LINK_TO_DC1-POD2-SPINE2_Ethernet4 | routed | - | 172.17.2.19/31 | default | 9214 | false | - | - |
| Ethernet1/3 | P2P_LINK_TO_DC1-POD2-SPINE3_Ethernet7 | routed | - | 172.17.2.21/31 | default | 9214 | false | - | - |
| Ethernet1/4 | P2P_LINK_TO_DC1-POD2-SPINE4_Ethernet7 | routed | - | 172.17.2.23/31 | default | 9214 | false | - | - |
...
interface Ethernet1/3
   description P2P_LINK_TO_DC1-POD2-SPINE3_Ethernet7
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet5
   description MLAG_PEER_DC1-POD2-LEAF13B_Ethernet5
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description MLAG_PEER_DC1-POD2-LEAF13B_Ethernet6
   no shutdown
   channel-group 5 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel5 | MLAG_PEER_DC1-POD2-LEAF13B_Po5 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel5
   description MLAG_PEER_DC1-POD2-LEAF13B_Po5
   no shutdown
   switchport
...
| 172.17.2.16 | 65001.200 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.2.18 | 65001.200 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
...
router bgp 65112.1300
   ...
   neighbor 172.17.2.18 description DC1-POD2-SPINE2_Ethernet4
   neighbor 172.17.2.20 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.2.20 remote-as 65001.200
   neighbor 172.17.2.20 description DC1-POD2-SPINE3_Ethernet7
   ...
   neighbor 172.20.2.5 description DC1-POD2-LEAF13B
