...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | mgmt | 10.6.33.22/24 | 10.6.33.1 |
...
| ------- | -------- | ---------- | ----- |
| - | AMS DC1 DC1_POD2 DC1-POD2-LEAF2A | All | Disabled |

### SNMP Device Configuration

```eos
!
snmp-server location AMS DC1 DC1_POD2 DC1-POD2-LEAF2A
```
...
| --------- | --------------- | ------------ | --------- |
| RACK2_MLAG | Vlan4094 | 172.19.33.43 | Port-Channel151 |
...
mlag configuration
   ...
   peer-address 172.19.33.43
   peer-address heartbeat 10.6.33.22 vrf mgmt
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet29/1 | P2P_LINK_TO_DC1-POD2-SPINE1_Ethernet3/1 | routed | - | 172.17.32.169/31 | default | 9214 | false | - | - |
| Ethernet30/1 | P2P_LINK_TO_DC1-POD2-SPINE2_Ethernet3/1 | routed | - | 172.17.32.171/31 | default | 9214 | false | - | - |
| Ethernet31/1 | P2P_LINK_TO_DC1-POD2-SPINE3_Ethernet3/1 | routed | - | 172.17.32.173/31 | default | 9214 | false | - | - |
| Ethernet32/1 | P2P_LINK_TO_DC1-POD2-SPINE4_Ethernet3/1 | routed | - | 172.17.32.175/31 | default | 9214 | false | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.4.33.24/32 |
...
| Vlan3099 |  Cust_A_VRF  |  172.19.33.42/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3199 |  Cust_B_VRF  |  172.19.33.42/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.19.33.42/31  |  -  |  -  |  -  |  -  |  -  |
...
!
interface Vxlan1
   description DC1-POD2-LEAF2A_VTEP
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- |
| 172.17.32.168 | 64701 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.17.32.170 | 64702 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.17.32.172 | 64703 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.17.32.174 | 64704 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.19.33.43 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
| 172.19.33.43 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_A_VRF | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
| 172.19.33.43 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_B_VRF | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 10.4.33.24:10100 | 10100:10100 | - | - | learned |
| 133 | 10.4.33.24:10133 | 10133:10133 | - | - | learned |
| 167 | 10.4.33.24:10167 | 10167:10167 | - | - | learned |
| 200 | 10.4.33.24:20200 | 20200:20200 | - | - | learned |
| 233 | 10.4.33.24:20233 | 20233:20233 | - | - | learned |
| 267 | 10.4.33.24:20267 | 20267:20267 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Cust_A_VRF | 10.4.33.24:100 | connected |
| Cust_B_VRF | 10.4.33.24:200 | connected |
...
router bgp 65002
   ...
   neighbor 172.17.32.168 remote-as 64701
   neighbor 172.17.32.168 description DC1-POD2-SPINE1_Ethernet3/1
   neighbor 172.17.32.170 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.32.170 remote-as 64702
   neighbor 172.17.32.170 description DC1-POD2-SPINE2_Ethernet3/1
   neighbor 172.17.32.172 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.32.172 remote-as 64703
   neighbor 172.17.32.172 description DC1-POD2-SPINE3_Ethernet3/1
   neighbor 172.17.32.174 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.32.174 remote-as 64704
   neighbor 172.17.32.174 description DC1-POD2-SPINE4_Ethernet3/1
   neighbor 172.19.33.43 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.19.33.43 description DC1-POD2-LEAF2B
