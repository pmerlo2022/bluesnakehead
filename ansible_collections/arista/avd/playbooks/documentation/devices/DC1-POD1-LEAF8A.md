...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet29/1 | P2P_LINK_TO_DC1-POD1-SPINE1_Ethernet15/1 | routed | - | 172.17.1.9/31 | default | 9214 | false | - | - |
| Ethernet30/1 | P2P_LINK_TO_DC1-POD1-SPINE2_Ethernet15/1 | routed | - | 172.17.1.11/31 | default | 9214 | false | - | - |
| Ethernet31/1 | P2P_LINK_TO_DC1-POD1-SPINE3_Ethernet15/1 | routed | - | 172.17.1.13/31 | default | 9214 | false | - | - |
| Ethernet32/1 | P2P_LINK_TO_DC1-POD1-SPINE4_Ethernet15/1 | routed | - | 172.17.1.15/31 | default | 9214 | false | - | - |
...
| -------- | --------- | --- | -------------- | -------------- |
| 172.17.1.8 | 64601 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.1.10 | 64602 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.1.12 | 64603 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.1.14 | 64604 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
...
router bgp 64908
   ...
   neighbor 172.17.1.8 remote-as 64601
   neighbor 172.17.1.8 description DC1-POD1-SPINE1_Ethernet15/1
   neighbor 172.17.1.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.1.10 remote-as 64602
   neighbor 172.17.1.10 description DC1-POD1-SPINE2_Ethernet15/1
   neighbor 172.17.1.12 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.1.12 remote-as 64603
   neighbor 172.17.1.12 description DC1-POD1-SPINE3_Ethernet15/1
   neighbor 172.17.1.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.1.14 remote-as 64604
   neighbor 172.17.1.14 description DC1-POD1-SPINE4_Ethernet15/1
