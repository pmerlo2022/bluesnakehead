...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | mgmt | 10.6.34.22/24 | 10.6.1.1 |
...
| --------- | --------------- | ------------ | --------- |
| RACK11_MLAG | Vlan4094 | 172.20.2.40 | Port-Channel151 |
...
mlag configuration
   ...
   peer-address 172.20.2.40
   peer-address heartbeat 10.6.34.22 vrf mgmt
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet15/1 | MLAG_PEER_DC1-POD2-LEAF11A_Ethernet15/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 151 |
| Ethernet16/1 | MLAG_PEER_DC1-POD2-LEAF11A_Ethernet16/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 151 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet29/1 | P2P_LINK_TO_DC1-POD2-SPINE1_Ethernet22/1 | routed | - | 172.17.2.169/31 | default | 9214 | false | - | - |
| Ethernet30/1 | P2P_LINK_TO_DC1-POD2-SPINE2_Ethernet22/1 | routed | - | 172.17.2.171/31 | default | 9214 | false | - | - |
| Ethernet31/1 | P2P_LINK_TO_DC1-POD2-SPINE3_Ethernet22/1 | routed | - | 172.17.2.173/31 | default | 9214 | false | - | - |
| Ethernet32/1 | P2P_LINK_TO_DC1-POD2-SPINE4_Ethernet22/1 | routed | - | 172.17.2.175/31 | default | 9214 | false | - | - |
...
interface Ethernet15/1
   description MLAG_PEER_DC1-POD2-LEAF11A_Ethernet15/1
   no shutdown
   channel-group 151 mode active
!
interface Ethernet16/1
   description MLAG_PEER_DC1-POD2-LEAF11A_Ethernet16/1
   no shutdown
   channel-group 151 mode active
!
interface Ethernet29/1
   description P2P_LINK_TO_DC1-POD2-SPINE1_Ethernet22/1
   no shutdown
   mtu 9214
   no switchport
...
interface Ethernet30/1
   description P2P_LINK_TO_DC1-POD2-SPINE2_Ethernet22/1
   no shutdown
   mtu 9214
   no switchport
...
interface Ethernet31/1
   description P2P_LINK_TO_DC1-POD2-SPINE3_Ethernet22/1
   no shutdown
   mtu 9214
   no switchport
...
interface Ethernet32/1
   description P2P_LINK_TO_DC1-POD2-SPINE4_Ethernet22/1
   no shutdown
   mtu 9214
   no switchport
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel151 | MLAG_PEER_DC1-POD2-LEAF11A_Po151 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel151
   description MLAG_PEER_DC1-POD2-LEAF11A_Po151
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.4.2.24/32 |
...
| Vlan3099 |  Cust_A_VRF  |  172.20.2.41/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3199 |  Cust_B_opzone  |  172.20.2.41/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.20.2.41/31  |  -  |  -  |  -  |  -  |  -  |
...
| 172.17.2.168 | 65001.200 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.2.170 | 65001.200 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.2.172 | 65001.200 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.2.174 | 65001.200 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.20.2.40 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.20.2.40 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_A_VRF | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.20.2.40 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_B_opzone | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 67 | 10.4.2.24:20067 | 20067:20067 | - | - | learned |
| 100 | 10.4.2.24:10100 | 10100:10100 | - | - | learned |
| 111 | 10.4.2.24:10111 | 10111:10111 | - | - | learned |
| 112 | 10.4.2.24:10112 | 10112:10112 | - | - | learned |
| 211 | 10.4.2.24:20211 | 20211:20211 | - | - | learned |
| 212 | 10.4.2.24:20212 | 20212:20212 | - | - | learned |
| 1500 | 10.4.2.24:11500 | 11500:11500 | - | - | learned |
| 1600 | 10.4.2.24:11600 | 11600:11600 | - | - | learned |
| 2520 | 10.4.2.24:22520 | 22520:22520 | - | - | learned |
| 2620 | 10.4.2.24:22620 | 22620:22620 | - | - | learned |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Cust_A_VRF | 10.4.2.24:100 | connected |
| Cust_B_opzone | 10.4.2.24:200 | connected |
...
router bgp 65112.1100
   ...
   neighbor 172.17.2.168 remote-as 65001.200
   neighbor 172.17.2.168 description DC1-POD2-SPINE1_Ethernet22/1
   neighbor 172.17.2.170 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.2.170 remote-as 65001.200
   neighbor 172.17.2.170 description DC1-POD2-SPINE2_Ethernet22/1
   neighbor 172.17.2.172 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.2.172 remote-as 65001.200
   neighbor 172.17.2.172 description DC1-POD2-SPINE3_Ethernet22/1
   neighbor 172.17.2.174 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.2.174 remote-as 65001.200
   neighbor 172.17.2.174 description DC1-POD2-SPINE4_Ethernet22/1
   neighbor 172.20.2.40 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.20.2.40 description DC1-POD2-LEAF11A
