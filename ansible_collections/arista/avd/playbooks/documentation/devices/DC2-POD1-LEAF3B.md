...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | mgmt | 10.6.35.25/24 | 10.6.65.1 |
...
| --------- | --------------- | ------------ | --------- |
| RACK3_MLAG | Vlan4094 | 172.19.65.48 | Port-Channel151 |
...
mlag configuration
   ...
   peer-address 172.19.65.48
   peer-address heartbeat 10.6.35.25 vrf mgmt
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet29/1 | P2P_LINK_TO_DC2-POD1-SPINE1_Ethernet6/1 | routed | - | 172.17.64.201/31 | default | 9214 | false | - | - |
| Ethernet30/1 | P2P_LINK_TO_DC2-POD1-SPINE2_Ethernet6/1 | routed | - | 172.17.64.203/31 | default | 9214 | false | - | - |
| Ethernet31/1 | P2P_LINK_TO_DC2-POD1-SPINE3_Ethernet6/1 | routed | - | 172.17.64.205/31 | default | 9214 | false | - | - |
| Ethernet32/1 | P2P_LINK_TO_DC2-POD1-SPINE4_Ethernet6/1 | routed | - | 172.17.64.207/31 | default | 9214 | false | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.4.65.28/32 |
...
| Vlan3099 |  Cust_A_VRF  |  172.19.65.49/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3199 |  Cust_B_VRF  |  172.19.65.49/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.19.65.49/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- |
| 172.17.64.200 | 64801 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.17.64.202 | 64802 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.17.64.204 | 64803 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.17.64.206 | 64804 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.19.65.48 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
| 172.19.65.48 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_A_VRF | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
| 172.19.65.48 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_B_VRF | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 10.4.65.28:10100 | 10100:10100 | - | - | learned |
| 133 | 10.4.65.28:10133 | 10133:10133 | - | - | learned |
| 167 | 10.4.65.28:10167 | 10167:10167 | - | - | learned |
| 200 | 10.4.65.28:20200 | 20200:20200 | - | - | learned |
| 233 | 10.4.65.28:20233 | 20233:20233 | - | - | learned |
| 267 | 10.4.65.28:20267 | 20267:20267 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Cust_A_VRF | 10.4.65.28:100 | connected |
| Cust_B_VRF | 10.4.65.28:200 | connected |
...
router bgp 65103
   ...
   neighbor 172.17.64.200 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.64.200 remote-as 64801
   neighbor 172.17.64.200 description DC2-POD1-SPINE1_Ethernet6/1
   neighbor 172.17.64.202 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.64.202 remote-as 64802
   neighbor 172.17.64.202 description DC2-POD1-SPINE2_Ethernet6/1
   neighbor 172.17.64.204 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.64.204 remote-as 64803
   neighbor 172.17.64.204 description DC2-POD1-SPINE3_Ethernet6/1
   neighbor 172.17.64.206 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.64.206 remote-as 64804
   neighbor 172.17.64.206 description DC2-POD1-SPINE4_Ethernet6/1
   neighbor 172.19.65.48 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.19.65.48 description DC2-POD1-LEAF3A
