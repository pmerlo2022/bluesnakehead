...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | mgmt | 10.6.35.43/24 | 10.6.65.1 |
...
| --------- | --------------- | ------------ | --------- |
| RACK12_MLAG | Vlan4094 | 172.19.65.84 | Port-Channel151 |
...
mlag configuration
   ...
   peer-address 172.19.65.84
   peer-address heartbeat 10.6.35.43 vrf mgmt
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet29/1 | P2P_LINK_TO_DC2-POD1-SPINE1_Ethernet24/1 | routed | - | 172.17.65.89/31 | default | 9214 | false | - | - |
| Ethernet30/1 | P2P_LINK_TO_DC2-POD1-SPINE2_Ethernet24/1 | routed | - | 172.17.65.91/31 | default | 9214 | false | - | - |
| Ethernet31/1 | P2P_LINK_TO_DC2-POD1-SPINE3_Ethernet24/1 | routed | - | 172.17.65.93/31 | default | 9214 | false | - | - |
| Ethernet32/1 | P2P_LINK_TO_DC2-POD1-SPINE4_Ethernet24/1 | routed | - | 172.17.65.95/31 | default | 9214 | false | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.4.65.46/32 |
...
| Vlan3099 |  Cust_A_VRF  |  172.19.65.85/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3199 |  Cust_B_VRF  |  172.19.65.85/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.19.65.85/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------------- | -------------- |
| 172.17.65.88 | 64801 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.65.90 | 64802 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.65.92 | 64803 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.65.94 | 64804 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.19.65.84 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.19.65.84 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_A_VRF | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.19.65.84 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_B_VRF | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 10.4.65.46:10100 | 10100:10100 | - | - | learned |
| 133 | 10.4.65.46:10133 | 10133:10133 | - | - | learned |
| 167 | 10.4.65.46:10167 | 10167:10167 | - | - | learned |
| 200 | 10.4.65.46:20200 | 20200:20200 | - | - | learned |
| 233 | 10.4.65.46:20233 | 20233:20233 | - | - | learned |
| 267 | 10.4.65.46:20267 | 20267:20267 | - | - | learned |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Cust_A_VRF | 10.4.65.46:100 | connected |
| Cust_B_VRF | 10.4.65.46:200 | connected |
...
router bgp 65112
   ...
   neighbor 172.17.65.88 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.65.88 remote-as 64801
   neighbor 172.17.65.88 description DC2-POD1-SPINE1_Ethernet24/1
   neighbor 172.17.65.90 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.65.90 remote-as 64802
   neighbor 172.17.65.90 description DC2-POD1-SPINE2_Ethernet24/1
   neighbor 172.17.65.92 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.65.92 remote-as 64803
   neighbor 172.17.65.92 description DC2-POD1-SPINE3_Ethernet24/1
   neighbor 172.17.65.94 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.65.94 remote-as 64804
   neighbor 172.17.65.94 description DC2-POD1-SPINE4_Ethernet24/1
   neighbor 172.19.65.84 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.19.65.84 description DC2-POD1-LEAF12A
