...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | mgmt | 10.6.35.29/24 | 10.6.65.1 |
...
| --------- | --------------- | ------------ | --------- |
| RACK5_MLAG | Vlan4094 | 172.19.65.56 | Port-Channel151 |
...
mlag configuration
   ...
   peer-address 172.19.65.56
   peer-address heartbeat 10.6.35.29 vrf mgmt
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet29/1 | P2P_LINK_TO_DC2-POD1-SPINE1_Ethernet10/1 | routed | - | 172.17.64.233/31 | default | 9214 | false | - | - |
| Ethernet30/1 | P2P_LINK_TO_DC2-POD1-SPINE2_Ethernet10/1 | routed | - | 172.17.64.235/31 | default | 9214 | false | - | - |
| Ethernet31/1 | P2P_LINK_TO_DC2-POD1-SPINE3_Ethernet10/1 | routed | - | 172.17.64.237/31 | default | 9214 | false | - | - |
| Ethernet32/1 | P2P_LINK_TO_DC2-POD1-SPINE4_Ethernet10/1 | routed | - | 172.17.64.239/31 | default | 9214 | false | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.4.65.32/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.5.65.31/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 10.4.65.32/32
!
interface Loopback1
   description VTEP_VXLAN_Tunnel_Source
   no shutdown
   ip address 10.5.65.31/32
```
...
| Vlan3099 |  Cust_A_VRF  |  172.19.65.57/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3199 |  Cust_B_VRF  |  172.19.65.57/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.19.65.57/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------------- | -------------- |
| 172.17.64.232 | 64801 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.64.234 | 64802 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.64.236 | 64803 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.64.238 | 64804 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.19.65.56 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.19.65.56 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_A_VRF | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.19.65.56 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_B_VRF | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 10.4.65.32:10100 | 10100:10100 | - | - | learned |
| 133 | 10.4.65.32:10133 | 10133:10133 | - | - | learned |
| 167 | 10.4.65.32:10167 | 10167:10167 | - | - | learned |
| 200 | 10.4.65.32:20200 | 20200:20200 | - | - | learned |
| 233 | 10.4.65.32:20233 | 20233:20233 | - | - | learned |
| 267 | 10.4.65.32:20267 | 20267:20267 | - | - | learned |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Cust_A_VRF | 10.4.65.32:100 | connected |
| Cust_B_VRF | 10.4.65.32:200 | connected |
...
router bgp 65105
   ...
   neighbor 172.17.64.232 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.64.232 remote-as 64801
   neighbor 172.17.64.232 description DC2-POD1-SPINE1_Ethernet10/1
   neighbor 172.17.64.234 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.64.234 remote-as 64802
   neighbor 172.17.64.234 description DC2-POD1-SPINE2_Ethernet10/1
   neighbor 172.17.64.236 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.64.236 remote-as 64803
   neighbor 172.17.64.236 description DC2-POD1-SPINE3_Ethernet10/1
   neighbor 172.17.64.238 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.64.238 remote-as 64804
   neighbor 172.17.64.238 description DC2-POD1-SPINE4_Ethernet10/1
   neighbor 172.19.65.56 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.19.65.56 description DC2-POD1-LEAF5A
