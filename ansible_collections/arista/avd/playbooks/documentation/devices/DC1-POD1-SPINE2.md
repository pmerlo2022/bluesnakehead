...
!
interface Ethernet4
   description P2P_LINK_TO_DC2-POD1-LEAF14A_Ethernet1/2
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet5
   description P2P_LINK_TO_DC2-POD1-LEAF14B_Ethernet1/2
   no shutdown
   mtu 9214
   no switchport
...
router bgp 65001.100
   ...
   neighbor 172.17.32.27 description DC2-POD1-LEAF14B_Ethernet1/2
