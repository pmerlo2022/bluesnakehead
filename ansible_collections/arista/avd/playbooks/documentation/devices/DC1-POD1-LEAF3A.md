...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet29/1 | P2P_LINK_TO_DC1-POD1-SPINE1_Ethernet5/1 | routed | - | 172.17.0.185/31 | default | 9214 | false | - | - |
| Ethernet30/1 | P2P_LINK_TO_DC1-POD1-SPINE2_Ethernet5/1 | routed | - | 172.17.0.187/31 | default | 9214 | false | - | - |
| Ethernet31/1 | P2P_LINK_TO_DC1-POD1-SPINE3_Ethernet5/1 | routed | - | 172.17.0.189/31 | default | 9214 | false | - | - |
| Ethernet32/1 | P2P_LINK_TO_DC1-POD1-SPINE4_Ethernet5/1 | routed | - | 172.17.0.191/31 | default | 9214 | false | - | - |
...
| -------- | --------- | --- | -------------- | -------------- |
| 172.17.0.184 | 64601 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.0.186 | 64602 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.0.188 | 64603 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.0.190 | 64604 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
...
router bgp 64903
   ...
   neighbor 172.17.0.184 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.0.184 remote-as 64601
   neighbor 172.17.0.184 description DC1-POD1-SPINE1_Ethernet5/1
   neighbor 172.17.0.186 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.0.186 remote-as 64602
   neighbor 172.17.0.186 description DC1-POD1-SPINE2_Ethernet5/1
   neighbor 172.17.0.188 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.0.188 remote-as 64603
   neighbor 172.17.0.188 description DC1-POD1-SPINE3_Ethernet5/1
   neighbor 172.17.0.190 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.0.190 remote-as 64604
   neighbor 172.17.0.190 description DC1-POD1-SPINE4_Ethernet5/1
