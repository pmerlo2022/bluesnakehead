...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet29/1 | P2P_LINK_TO_DC1-POD1-SPINE1_Ethernet28/1 | routed | - | 172.17.1.113/31 | default | 9214 | false | - | - |
| Ethernet30/1 | P2P_LINK_TO_DC1-POD1-SPINE2_Ethernet28/1 | routed | - | 172.17.1.115/31 | default | 9214 | false | - | - |
| Ethernet31/1 | P2P_LINK_TO_DC1-POD1-SPINE3_Ethernet28/1 | routed | - | 172.17.1.117/31 | default | 9214 | false | - | - |
| Ethernet32/1 | P2P_LINK_TO_DC1-POD1-SPINE4_Ethernet28/1 | routed | - | 172.17.1.119/31 | default | 9214 | false | - | - |
...
| -------- | --------- | --- | -------------- | -------------- |
| 172.17.1.112 | 64601 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.1.114 | 64602 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.1.116 | 64603 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.17.1.118 | 64604 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
...
router bgp 64914
   ...
   neighbor 172.17.1.112 remote-as 64601
   neighbor 172.17.1.112 description DC1-POD1-SPINE1_Ethernet28/1
   neighbor 172.17.1.114 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.1.114 remote-as 64602
   neighbor 172.17.1.114 description DC1-POD1-SPINE2_Ethernet28/1
   neighbor 172.17.1.116 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.1.116 remote-as 64603
   neighbor 172.17.1.116 description DC1-POD1-SPINE3_Ethernet28/1
   neighbor 172.17.1.118 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.1.118 remote-as 64604
   neighbor 172.17.1.118 description DC1-POD1-SPINE4_Ethernet28/1
