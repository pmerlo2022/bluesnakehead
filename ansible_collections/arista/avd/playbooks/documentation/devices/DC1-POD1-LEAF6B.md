...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet29/1 | P2P_LINK_TO_DC1-POD1-SPINE1_Ethernet6/3 | routed | - | 172.17.3.193/31 | default | 9214 | false | - | - |
| Ethernet29/2 | P2P_LINK_TO_DC1-POD1-SPINE1_Ethernet6/4 | routed | - | 172.17.3.195/31 | default | 9214 | false | - | - |
| Ethernet30/1 | P2P_LINK_TO_DC1-POD1-SPINE2_Ethernet6/3 | routed | - | 172.17.3.197/31 | default | 9214 | false | - | - |
| Ethernet30/2 | P2P_LINK_TO_DC1-POD1-SPINE2_Ethernet6/4 | routed | - | 172.17.3.199/31 | default | 9214 | false | - | - |
| Ethernet31/1 | P2P_LINK_TO_DC1-POD1-SPINE3_Ethernet6/3 | routed | - | 172.17.3.201/31 | default | 9214 | false | - | - |
| Ethernet31/2 | P2P_LINK_TO_DC1-POD1-SPINE3_Ethernet6/4 | routed | - | 172.17.3.203/31 | default | 9214 | false | - | - |
| Ethernet32/1 | P2P_LINK_TO_DC1-POD1-SPINE4_Ethernet6/3 | routed | - | 172.17.3.205/31 | default | 9214 | false | - | - |
| Ethernet32/2 | P2P_LINK_TO_DC1-POD1-SPINE4_Ethernet6/4 | routed | - | 172.17.3.207/31 | default | 9214 | false | - | - |
...
interface Ethernet29/1
   description P2P_LINK_TO_DC1-POD1-SPINE1_Ethernet6/3
   no shutdown
   speed forced 100g
   mtu 9214
   no switchport
   ip address 172.17.3.193/31
   ptp enable
   service-profile P2P-QOS-PROFILE
!
interface Ethernet29/2
   description P2P_LINK_TO_DC1-POD1-SPINE1_Ethernet6/4
   no shutdown
   speed forced 100g
   mtu 9214
   no switchport
   ip address 172.17.3.195/31
   ptp enable
   service-profile P2P-QOS-PROFILE
!
interface Ethernet30/1
   description P2P_LINK_TO_DC1-POD1-SPINE2_Ethernet6/3
   no shutdown
   speed forced 100g
   mtu 9214
   no switchport
   ip address 172.17.3.197/31
   ptp enable
   service-profile P2P-QOS-PROFILE
!
interface Ethernet30/2
   description P2P_LINK_TO_DC1-POD1-SPINE2_Ethernet6/4
   no shutdown
   speed forced 100g
   mtu 9214
   no switchport
   ip address 172.17.3.199/31
   ptp enable
   service-profile P2P-QOS-PROFILE
!
interface Ethernet31/1
   description P2P_LINK_TO_DC1-POD1-SPINE3_Ethernet6/3
   no shutdown
   speed forced 100g
   mtu 9214
   no switchport
   ip address 172.17.3.201/31
   ptp enable
   service-profile P2P-QOS-PROFILE
!
interface Ethernet31/2
   description P2P_LINK_TO_DC1-POD1-SPINE3_Ethernet6/4
   no shutdown
   speed forced 100g
   mtu 9214
   no switchport
   ip address 172.17.3.203/31
   ptp enable
   service-profile P2P-QOS-PROFILE
!
interface Ethernet32/1
   description P2P_LINK_TO_DC1-POD1-SPINE4_Ethernet6/3
   no shutdown
   speed forced 100g
   mtu 9214
   no switchport
   ip address 172.17.3.205/31
   ptp enable
   service-profile P2P-QOS-PROFILE
!
interface Ethernet32/2
   description P2P_LINK_TO_DC1-POD1-SPINE4_Ethernet6/4
   no shutdown
   speed forced 100g
   mtu 9214
   no switchport
   ip address 172.17.3.207/31
   ptp enable
   service-profile P2P-QOS-PROFILE
```
...
| Vlan4094 |  default  |  172.19.1.59/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- |
| 172.17.3.192 | 64601 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.17.3.194 | 64601 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.17.3.196 | 64602 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.17.3.198 | 64602 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.17.3.200 | 64603 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.17.3.202 | 64603 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.17.3.204 | 64604 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.17.3.206 | 64604 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
...
router bgp 64906
   ...
   neighbor 172.17.3.192 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.3.192 remote-as 64601
   neighbor 172.17.3.192 description DC1-POD1-SPINE1_Ethernet6/3
   neighbor 172.17.3.194 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.3.194 remote-as 64601
   neighbor 172.17.3.194 description DC1-POD1-SPINE1_Ethernet6/4
   neighbor 172.17.3.196 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.3.196 remote-as 64602
   neighbor 172.17.3.196 description DC1-POD1-SPINE2_Ethernet6/3
   neighbor 172.17.3.198 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.3.198 remote-as 64602
   neighbor 172.17.3.198 description DC1-POD1-SPINE2_Ethernet6/4
   neighbor 172.17.3.200 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.3.200 remote-as 64603
   neighbor 172.17.3.200 description DC1-POD1-SPINE3_Ethernet6/3
   neighbor 172.17.3.202 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.3.202 remote-as 64603
   neighbor 172.17.3.202 description DC1-POD1-SPINE3_Ethernet6/4
   neighbor 172.17.3.204 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.3.204 remote-as 64604
   neighbor 172.17.3.204 description DC1-POD1-SPINE4_Ethernet6/3
   neighbor 172.17.3.206 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.3.206 remote-as 64604
   neighbor 172.17.3.206 description DC1-POD1-SPINE4_Ethernet6/4
