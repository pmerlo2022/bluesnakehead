...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_DC2-POD1-SPINE4_Ethernet3 | routed | - | 172.16.32.134/31 | default | 9214 | false | - | - |
| Ethernet17/3 | P2P_LINK_TO_DC1-POD2-SPINE4_Ethernet3 | routed | - | 172.16.2.134/31 | default | 9214 | false | - | - |
...
!
interface Ethernet3
   description P2P_LINK_TO_DC2-POD1-SPINE4_Ethernet3
   no shutdown
   mtu 9214
   no switchport
...
interface Ethernet17/3
   description P2P_LINK_TO_DC1-POD2-SPINE4_Ethernet3
   no shutdown
   mtu 9214
   no switchport
...
router bgp 65100
   ...
   neighbor 172.16.2.135 description DC1-POD2-SPINE4_Ethernet3
   neighbor 172.16.32.135 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.32.135 remote-as 65002.100
   neighbor 172.16.32.135 description DC2-POD1-SPINE4_Ethernet3
