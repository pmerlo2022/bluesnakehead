...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | mgmt | 10.6.35.20/24 | 10.6.65.1 |
...
| --------- | --------------- | ------------ | --------- |
| RACK1_MLAG | Vlan4094 | 172.19.65.39 | Port-Channel151 |
...
mlag configuration
   ...
   peer-address 172.19.65.39
   peer-address heartbeat 10.6.35.20 vrf mgmt
...
| Ethernet32/1 | P2P_LINK_TO_DC2-POD1-SPINE4_Ethernet1/1 | routed | - | 172.17.64.159/31 | default | 9214 | false | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.4.65.22/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.5.65.22/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 10.4.65.22/32
!
interface Loopback1
   description VTEP_VXLAN_Tunnel_Source
   no shutdown
   ip address 10.5.65.22/32
```
...
| Vlan3099 |  Cust_A_VRF  |  172.19.65.38/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3199 |  Cust_B_VRF  |  172.19.65.38/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.19.65.38/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- |
| 172.17.64.152 | 64801 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.17.64.154 | 64802 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.17.64.156 | 64803 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.17.64.158 | 64804 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.19.65.39 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
| 200.200.200.202 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.19.65.39 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_A_VRF | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
| 172.19.65.39 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Cust_B_VRF | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 200 | 10.4.65.22:20200 | 20200:20200 | - | - | learned |
| 233 | 10.4.65.22:20233 | 20233:20233 | - | - | learned |
| 267 | 10.4.65.22:20267 | 20267:20267 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Cust_A_VRF | 10.4.65.22:100 | connected |
| Cust_B_VRF | 10.4.65.22:200 | connected |
...
router bgp 65101
   ...
   neighbor 172.17.64.152 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.64.152 remote-as 64801
   neighbor 172.17.64.152 description DC2-POD1-SPINE1_Ethernet1/1
   neighbor 172.17.64.154 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.64.154 remote-as 64802
   neighbor 172.17.64.154 description DC2-POD1-SPINE2_Ethernet1/1
   neighbor 172.17.64.156 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.64.156 remote-as 64803
   neighbor 172.17.64.156 description DC2-POD1-SPINE3_Ethernet1/1
   neighbor 172.17.64.158 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.64.158 remote-as 64804
   neighbor 172.17.64.158 description DC2-POD1-SPINE4_Ethernet1/1
   neighbor 172.19.65.39 peer group MLAG-IPv4-UNDERLAY-PEER
