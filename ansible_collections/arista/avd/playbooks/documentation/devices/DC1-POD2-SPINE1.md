...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | mgmt | 192.168.1.13/24 | 10.6.1.1 |
...
| 172.17.120.7 | 65121 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
...
router bgp 65120
   ...
   neighbor 172.17.120.7 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.17.120.7 remote-as 65121
   neighbor 172.17.120.7 description DC1-POD2-LEAF1B_Ethernet1
