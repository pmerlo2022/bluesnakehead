...
| ------- | -------- | ---------- | ----- |
| - | AMS DC1 DC1-SUPER-SPINE1 | All | Disabled |

### SNMP Device Configuration

```eos
!
snmp-server location AMS DC1 DC1-SUPER-SPINE1
```
...
| Ethernet6 | P2P_LINK_TO_DC2-SUPER-SPINE1_Ethernet4 | routed | - | 11.1.2.0/31 | default | 9214 | false | - | - |
